# Generated by Django 4.1.6 on 2023-02-03 09:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sign_of_version', models.CharField(choices=[('active', 'активная'), ('inactive', 'не активная')], default='inactive', max_length=15, verbose_name='текущая версия')),
                ('product_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='versions', to='catalog.product')),
            ],
        ),
    ]
